...
/**
 * <!-- begin-user-doc -->
 * A test suite for the '<em><b>AttackTree</b></em>' model.
 * <!-- end-user-doc -->
 * @generated
 */
public class AttackTreeAllTests extends TestSuite {
	...
	public static Test suite() {
		TestSuite suite = new AttackTreeAllTests("AttackTree Tests");
		return suite;
	}
	 ...
	 * @generated
	 */
	public AttackTreeAllTests(String name) {
		super(name);
	}
