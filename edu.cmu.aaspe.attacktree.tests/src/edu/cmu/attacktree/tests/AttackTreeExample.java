...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>attacktree</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class AttackTreeExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(AttackTreePackage.eNS_URI, 
			 AttackTreePackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.attacktree"));
				Node root = AttackTreeFactory.eINSTANCE.createNode();
