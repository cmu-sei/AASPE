 ...
 * @generated
 */
public class AttackTreeFactoryImpl extends EFactoryImpl implements AttackTreeFactory {
	/**
	 ...
	 * @generated
	 */
	public static AttackTreeFactory init() {
		try {
			AttackTreeFactory theAttackTreeFactory = (AttackTreeFactory)EPackage.Registry.INSTANCE.getEFactory(AttackTreePackage.eNS_URI);
			if (theAttackTreeFactory != null) {
				return theAttackTreeFactory;
			}
		}
		catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new AttackTreeFactoryImpl();
	}
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case AttackTreePackage.NODE: return createNode();
			case AttackTreePackage.VULNERABILITY: return createVulnerability();
			case AttackTreePackage.MODEL: return createModel();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case AttackTreePackage.VULNERABILITY_TYPE:
				return createvulnerabilityTypeFromString(eDataType, initialValue);
			case AttackTreePackage.PROPAGATION_TYPE:
	 ...
	 * @generated
	 */
	public AttackTreePackage getAttackTreePackage() {
		return (AttackTreePackage)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static AttackTreePackage getPackage() {
		return AttackTreePackage.eINSTANCE;
	}

} //AttackTreeFactoryImpl
