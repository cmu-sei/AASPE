/**
 */
package edu.cmu.attacktree.provider;
...
/**
 * This is the item provider adapter for a {@link edu.cmu.attacktree.Model} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AttackTreePackage.Literals.MODEL__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AttackTreePackage.Literals.MODEL__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AttackTreePackage.Literals.MODEL__ROOT_NODE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AttackTreePackage.Literals.MODEL__ROOT_NODE,
				 AttackTreeFactory.eINSTANCE.createNode()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return AttackTreeEditPlugin.INSTANCE;
	}
